...
namespace Be.Stateless.BizTalk.Schema
{
	public interface ISchemaMetadata
	{
		...
		/// <summary>
		/// Returns the <see cref="DocumentSpec"/> of a given <see cref="SchemaBase"/>-derived envelope schema <see cref="Type"/>.
		/// </summary>
		/// <returns>
		...
		/// <summary>
		/// Returns the <see cref="BTS.MessageType"/> that any message being an instance of the <see cref="SchemaBase"/>-derived
		/// <see cref="Type"/> will have.
		/// </summary>
		/// <returns>
		/// The <see cref="BTS.MessageType"/> that any message being an instance of the <see cref="SchemaBase"/>-derived <see
		/// cref="Type"/> will have.
		/// </returns>
		...
		/// </summary>
		/// <returns>
		/// The <see cref="SchemaBase"/>-derived <see cref="Type"/> to which this <see cref="ISchemaMetadata"/> is associated.
		/// </returns>
		Type Type { get; }
	}
}
